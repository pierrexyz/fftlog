...
import config
global is_jax
is_jax = config.get_jax_enabled()
if is_jax:
    print("using jax")
    from jax import jit, vmap, disable_jit
    import jax.numpy as numpy
    from jax.numpy import load, array, ndarray, conj, ones, tan, log, logspace, swapaxes, empty, linspace, arange, delete, where, pi, cos, sin, log, exp, sqrt,concatenate, ones, zeros, real, where
    from jax.numpy.fft import rfft

else:
    import numpy
    from numpy import load, ndarray, conj, ones, tan, log, logspace, swapaxes, empty, array, linspace, arange, delete, where, pi, cos, sin, log, exp, sqrt, concatenate, ones, zeros, real, where
